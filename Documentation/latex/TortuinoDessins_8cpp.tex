...
Seulement, cela ne fonctionne pas trop car il est difficile de décoréler les paramètres du robot pour pouvoir calculer les valeurs nécessaires à une approximation relativement correcte d\textquotesingle{}un cercle par un polygone régulier à un grand nombre de côtés.
